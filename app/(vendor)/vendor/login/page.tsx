    ...
    <div className="w-full max-w-4xl grid gap-6 md:gap-8 md:grid-cols-2 md:items-center">
      ...
      <div className="hidden md:block space-y-6">
        <div>
          ...
          <p className="mt-2 text-muted-foreground leading-relaxed">
            Join our marketplace of trusted pet businesses. Manage your store, list puppies and products, and connect with pet lovers.
          </p>
        </div>

        <div className="grid grid-cols-2 gap-3">
          {FEATURES.map(({ icon: Icon, label }) => (
            <div key={label} className="flex items-center gap-2.5 rounded-lg border bg-card/50 p-3 text-sm">
        ...
        <p className="text-xs text-muted-foreground">
          Free to get started &middot; No monthly fees &middot; Pay only when you sell
        </p>
      </div>
        ...
        <CardContent>
          ...
          <div className="mt-6 space-y-2 text-center text-sm">
            <p className="text-muted-foreground">
              ...
              <Link href="/vendor/signup" className="font-medium text-primary hover:underline">
                Sign up free
              </Link>
            </p>
      ...
      <div className="md:hidden space-y-3">
        <div className="grid grid-cols-2 gap-2">
          {FEATURES.map(({ icon: Icon, label }) => (
            <div key={label} className="flex items-center gap-2 rounded-lg border bg-card/50 p-2.5 text-xs">
