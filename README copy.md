...
| Auth | Firebase Authentication + NextAuth v5 (JWT strategy) |
...
- **Dual Auth**: Firebase Auth handles client-side auth; NextAuth provides JWT sessions with role support.
