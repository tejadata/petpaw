...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    trait: "sizeCategory",
    options: [
      { value: "small", label: "Small", description: "Under 11 kg" },
      { value: "medium", label: "Medium", description: "11–27 kg" },
      { value: "large", label: "Large", description: "27–45 kg" },
      { value: "giant", label: "Giant", description: "Over 45 kg" },
